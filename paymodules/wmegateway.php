...
?>
<?
class wmegatewayPaymentGateway {
	...
	public function Info(){
		return array('name' => 'WebMoney WME');
	}
	...
	public function OperateRequirements(){
		$arr = array(
		0 => array('type' => 'text', 'label' => 'WME Purse', 'name'=> 'wmepurse'),
	...
	public function Form($operate_array, $data_array){
		...
		<input type="hidden" name="LMI_PAYEE_PURSE" value="'.$operate_array['wmepurse'].'">
