...
?>
<?
class othertestgatewayPaymentGateway {
	...
	public function Info(){
		return array('name' => 'Other Test Gateway');
	}
	public function Currency(){
		return array('eur', 'usd', 'rur');
	}
	public function OperateRequirements(){
		$arr = array(
		0 => array('type' => 'text', 'label' => 'WMZ Purse', 'name'=> 'wmzpurse'),
	...
	public function Form($operate_array, $data_array){
		...
		<input type="hidden" name="LMI_PAYEE_PURSE" value="'.$operate_array['wmzpurse'].'">
