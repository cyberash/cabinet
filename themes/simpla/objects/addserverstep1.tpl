			<div class="content-box">
				...
				<div class="content-box-header">
					...
					<h3>{LANG.addnewserverstepone}</h3>
...
<!-- END: groupslisterror -->
					...
					<input type="hidden" name="action" value="addserverstep2">
					<fieldset>
						<p>
							<label>{LANG.groupfornewserver}:</label>
							<select class="small-input" name="servergroup" {DISABLED}>
<!-- BEGIN: groupslist -->
							<option value="{GROUP.id}">{GROUP.name}</option>
<!-- END: groupslist -->
							</select>
							<br><small>{LANG.choosepropergroupfornewserver}</small>
						</p>
						<p>
